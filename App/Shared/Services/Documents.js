...
export const getDocuments = (id, page, pageSize) => apiClient.get(`/documents?filters[users_permissions_user][id][$eq]=${id}&populate=*&sort[0]=createdAt:desc&pagination[page]=${page}&pagination[pageSize]=${pageSize}`);
