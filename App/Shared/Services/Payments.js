...
export const getPayments = (id, page, pageSize) => apiClient.get(`/payments?filters[users_permissions_user][id][$eq]=${id}&sort[0]=createdAt:desc&pagination[page]=${page}&pagination[pageSize]=${pageSize}`);
